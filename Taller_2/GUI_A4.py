...
"")
        ...
        self.horizontalSlider_3.setMinimum(0)   # Voltaje mínimo 1 V
        self.horizontalSlider_3.setMaximum(5) # hasta 5 V
    ...
    def update_plot(self):
        ...
        C = self.horizontalSlider_2.value() * 1e-6  
        ...
        ax.plot(t, carga, label="Carga")
        ax.plot(t, descarga, label="Descarga", linestyle="--")
